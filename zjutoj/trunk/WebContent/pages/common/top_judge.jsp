			...
			<div class="nav_content">
				<div class="nav_content_left">
					<ul>
						...
						<li><a href="<%=path%>/study/problemInfoAction.do?method=list" >题库信息</a></li>
						<li><a href="<%=path%>/study/commentInfoAction.do?method=list" >评论信息</a></li>
						<li><a href="<%=path%>/study/answerInfoAction.do?method=list">题解信息</a></li>
						<li><a href="<%=path%>/match/contestInfoAction.do?method=list">竞赛信息</a></li>
<!-- 						<li><a href="javascript:void(0);">Contest</a></li> -->
						<li><a href="<%=path%>/study/problemInfoAction.do?method=mlist">后台管理</a></li>
						<li><a href="<%=path%>">官网</a></li>
					</ul>
				</div>
			</div>
