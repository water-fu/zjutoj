...
<script type="text/javascript">	
	function modify(id) {
		location.href = path + '/study/answerInfoAction.do?method=modifyUI&answerId='+id;
	}
	...
	function success(data) {
		...
		if(data.code == 1) {
			...
			var url = path + '/study/answerInfoAction.do?method=list&pageNo='+pageNo;
			location.href = url;
		}else if(data.code == 2) {
...
<body>
	...
	<div class="content">
		...
		<div class="toolbar">
			<ul>
				<s:if test="#answerInfoBean.userInfoBean.userId == #request.userInfoBean.userId">
